                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            ...
                            <div class="ml-12">
                                <form action="beans" method="POST" class="form-control" >
                                    <input type="text" name="name" class="border-t border-r md:border-l">
                                    <!-- //Shows error message "The name field is required" -->
                                    <div>
                                        {{ $errors->first('name') }}
                                    </div>
                                    <select class="form-control" name="caffeine_level">
                                        <option selected value="">Caffeine Level</option>
